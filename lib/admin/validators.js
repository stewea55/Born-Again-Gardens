const RESOURCE_CONFIG = {
  ...
  transaction: {
    ...
    writableFields: [
      ...
      { key: "customer_email", type: "text" },
      { key: "payment", type: "number" },
      { key: "donation_amount", type: "number" },
      { key: "flow_type", type: "text" },
      { key: "checkout_context", type: "json" },
  ...
  tree_campaign: {
    ...
    writableFields: [
      { key: "total_quantity", type: "number" },
      { key: "quantity_remaining", type: "number" },
      { key: "active", type: "boolean" },
      { key: "price_per_tree", type: "number" },
      { key: "image_url", type: "text" }
    ]
  },
  tree_dedications: {
    ...
    orderBy: { column: "created_at", ascending: false },
    writableFields: [
      { key: "transaction_id", type: "number" },
      { key: "full_name", type: "text" },
      { key: "email", type: "text" },
      { key: "dedication_text", type: "text" },
      { key: "dedication_image", type: "text" },
      { key: "payment_confirmation", type: "text" }
    ]
  },
  resources: {
